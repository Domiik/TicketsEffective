...
class GetOffers {
    ...
    func getOffers(completed: @escaping (Result<Offers, APError>) -> Void) {
        if connectivity.isConnected {
            
            let endURL = URLComponents(string: Constants.offerURL)!
            ...
            let task = URLSession.shared.dataTask(with: url) { data, response, error in
                ...
                do {
                    ...
                    let decodedResponse = try decoder.decode(Offers.self, from: data)
