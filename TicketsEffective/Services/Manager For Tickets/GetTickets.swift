...
class GetTickets {
    ...
    func getTickets(completed: @escaping (Result<Tickets, APError>) -> Void) {
        if connectivity.isConnected {
            
            let endURL = URLComponents(string: Constants.ticketsURL)!
            ...
            let task = URLSession.shared.dataTask(with: url) { data, response, error in
                ...
                do {
                    ...
                    let decodedResponse = try decoder.decode(Tickets.self, from: data)
